...
export function Footer() {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/nirvishah', // Replace with your LinkedIn
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/nirvisha', // Replace with your GitHub
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
          <path d="M12 8.5L6 14v-2l6-5.5L18 12v2l-6-5.5z"/>
          <path d="M7 15v2c0 2 1 3 5 3s5-1 5-3v-2l-5 3-5-3z"/>
        </svg>
      ),
