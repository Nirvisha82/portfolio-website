...
export function About() {
  ...
  return (
    <section id="about" className="min-h-screen py-12 sm:py-16 lg:py-20 px-4 sm:px-6 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 delay-300 ${
            ...
            <div className="relative group">
              ...
              <div className={`absolute -top-3 -right-3 sm:-top-6 sm:-right-6 bg-white dark:bg-gray-800 px-2 py-1 sm:px-4 sm:py-2 rounded-full shadow-md sm:shadow-lg border border-gray-200 dark:border-gray-700 about-animate-float transition-all duration-1000 delay-500 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}>
                <span className="text-xs sm:text-sm font-semibold text-gray-700 dark:text-gray-300">🚀 Backend Dev</span>
              </div>
              
              <div className={`absolute -bottom-3 -left-3 sm:-bottom-6 sm:-left-6 bg-white dark:bg-gray-800 px-2 py-1 sm:px-4 sm:py-2 rounded-full shadow-md sm:shadow-lg border border-gray-200 dark:border-gray-700 about-animate-float transition-all duration-1000 delay-700 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          ...
          {/* Right Side - Content */}
          <div className={`space-y-4 sm:space-y-6 px-4 sm:px-6 lg:px-8 transition-all duration-1000 delay-500 ${
            isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'
          }`}>
            <div>
            ...
            <div className={`pt-2 sm:pt-4 transition-all duration-1000 delay-1000 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              <a 
