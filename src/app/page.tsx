          ...
          <div className="relative z-10 text-center max-w-6xl mx-auto">
            ...
            <div className="flex gap-6 justify-center items-center mb-12">
              <a
                ...
                className="group p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all duration-300"
              >
                <svg viewBox="0 0 24 24" className="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300" fill="currentColor">
              ...
              <a
                ...
                className="group p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all duration-300"
              >
                <svg viewBox="0 0 24 24" className="w-6 h-6 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors duration-300" fill="currentColor">
              ...
              <a
                ...
                className="group p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50 transition-all duration-300"
              >
                <svg viewBox="0 0 24 24" className="w-6 h-6 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300" fill="currentColor">
