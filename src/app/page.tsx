        ...
        <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-6xl mx-auto w-full">
            ...
            <div className="mb-4 sm:mb-6">
              <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 text-purple-600 dark:text-purple-400 rounded-full text-xs sm:text-sm font-medium mb-3 sm:mb-4 border border-purple-200 dark:border-purple-800 backdrop-blur-sm">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 leading-tight text-gray-900 dark:text-white px-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-6 sm:mb-8 px-4">
              ...
              <button className="border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:border-purple-500 dark:hover:border-purple-400 hover:text-purple-600 dark:hover:text-purple-400 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold transition-all duration-300 backdrop-blur-sm w-full sm:w-auto text-sm sm:text-base">
                Download Resume
              </button>
            </div>
            
            {/* Social Links - Better mobile spacing */}
            <div className="flex gap-4 sm:gap-6 justify-center items-center mb-8 sm:mb-12">
              <a
