...
<div className="relative z-10 text-center max-w-6xl mx-auto w-full">
  ...
  {/* TOP SPACER - Creates visual balance */}
  ...
  {/* MAIN HEADING - This will now appear visually centered */}
  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 sm:mb-8 leading-tight text-gray-900 dark:text-white px-2">
  ...
  {/* BOTTOM CONTENT - Balanced spacing */}
